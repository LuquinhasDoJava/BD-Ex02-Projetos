...
--05
SELECT filmeid, FORMAT(data_fabricacao, 'dd/MM/yyyy') AS fab
FROM dvd
WHERE data_fabricacao >= '2020-01-01';

--06
SELECT dvdnum, data_locacao, data_devolucao, valor, (valor+2.00) as valor_multa
FROM locacao
...
--09
SELECT num_cadrastado, nome, CONCAT(logradouro,', ',num, ', ', cep) AS end_comp
FROM cliente
WHERE num_cadrastado >= 5503;
--Fim dos SELECTS;
